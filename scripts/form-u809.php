...
function emailFormSubmission()
{
	...
	$subject = 'about me/ contact Form Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Company:</b></td><td>' . htmlentities($_REQUEST["custom_U1625"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U823"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Message:</b></td><td>' . htmlentities($_REQUEST["custom_U812"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Work Phone:</b></td><td>' . htmlentities($_REQUEST["custom_U1620"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Website:</b></td><td>' . htmlentities($_REQUEST["custom_U1630"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
